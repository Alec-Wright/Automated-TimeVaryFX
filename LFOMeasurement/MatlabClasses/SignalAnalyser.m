...
%             i = find(obj.Spectrograms{:,'processed_sig'} == proc_i);
        ...
        function obj = LFOTrack(obj, spec_num, smooth_f)

            if ~obj.Spectrograms{spec_num, "notch_start_fr"}
                [st_fr, st_i] = obj.LFOTrackInit(spec_num);
        ...
        function [no_fr, time_ind] = LFOTrackInit(obj, spec_num)
        ...
        function [ntch_fr] = NotchTracker(obj, spec_num, spec, smo_f)
